        ...
        <nav id="coodiv-navbar-header" class="navbar navbar-expand-md fixed-header-layout">
            <div class="container main-header-coodiv-s">
                ...
                <div class="collapse navbar-collapse navbar-offcanvas" id="offcanvas-menu-home">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown active">
                            <a class="nav-link" href="#" role="button" id="header-first-drop-down" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home<span class="sr-only">(current)</span></a>
                            <!-- <ul class="dropdown-menu coodiv-dropdown-header" aria-labelledby="header-first-drop-down">
                                ...
                                <li><a class="dropdown-item" href="index.html">homepage 02<span class="nav-new-tag">new</span></a></li>
								<li><a class="dropdown-item" href="index-video.html">homepage 03<span class="nav-soon-tag">new</span></a></li>
                                <li><a class="dropdown-item" href="https://coodiv.net/whmcs/index.php?systpl=bredh-standard-moon">WHMCS version</a></li>
                            </ul> -->
                        </li>
                       ...
                       <li class="nav-item megamenu dropdown">
							...
							<h5>web hosting</h5>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem, veritatis nulla eum laudantium.</p>
							</a>
							</div>
                        ...
                        <li class="nav-item dropdown">
							...
							<li><i class="fas fa-server"></i> <a href="hosting.html">shared hosting <span>Lorem ipsum dolor sit amet, consectetur adipisicing</span></a></li>
							<li><i class="fab fa-squarespace"></i> <a href="dedicated.html">dedicated hosting <span>Lorem ipsum dolor sit amet, consectetur adipisicing</span></a></li>
							<li><i class="fas fa-gamepad"></i> <a href="games.html">games servers <span>Lorem ipsum dolor sit amet, consectetur adipisicing</span></a></li>
							<li><i class="fas fa-cloud"></i> <a href="servers.html">cloud servers <span>Lorem ipsum dolor sit amet, consectetur adipisicing</span></a></li>
							<li><i class="fab fa-cpanel"></i> <a href="cpanel.html">cPanel Resellers <span>Lorem ipsum dolor sit amet, consectetur adipisicing</span></a></li>
							</ul>
                            </div>
                        </li>
                ...
                <ul class="header-user-info-coodiv">
                    <li class="dropdown"><a role="button" id="header-login-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"><i class="bredhicon-user"></i></a> <!--<span>12365-8448</span>-->
...
<!-- 	
	...
	<div class="container">
	<h5 class="title-default-coodiv-two">The latest news in our blog <span>Lorem Ipsum Dolor Sit Amet Lorem <br>Lorem Ipsum Dolor.</span></h5>
                ...
                <div class="col-md-4"><!-- col -->
                    <div class="home-blog-te"><!-- blog container -->
                        ...
                        <div class="post-bodyn">
                            ...
                            <p><i class="far fa-calendar"></i>Mars 22,2019</p><!-- post date -->
                        </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-between final-footer-area mr-tp-40">
                <div class="final-footer-area-text">
                    © Copyright 2019 coodiv , made with love in ageria
                </div>
